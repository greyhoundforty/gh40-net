...
```shell
for i in $(ic sl hardware list --output json | jq -r '.[].id'); do echo "${i}"; ic sl hardware detail "${i}" --output json | jq -r '.operatingSystem.softwareLicense.softwareDescription.manufacturer'; done
```
...
```
To check for 1GB appliance options change `VIRTUAL_ROUTER_APPLIANCE_10_GPBS` to `VIRTUAL_ROUTER_APPLIANCE_1_GPBS`

**Example Output**

```shell
ibmcloud sl order item-list VIRTUAL_ROUTER_APPLIANCE_1_GPBS --output json | jq -r '.[] | select(.itemCategory.categoryCode=="os") | .keyName'
OS_JUNIPER_VSRX_19_4_UP_TO_1GBPS_STANDARD_SRIOV
OS_VIRTUAL_ROUTER_APPLIANCE_19_X_UP_TO_2_GBPS_SUBSCRIPTION_EDITION_64_BIT
OS_JUNIPER_VSRX_22_2R2S2_UP_TO_1GBPS_STANDARD
OS_VIRTUAL_FORTIGATE_7_4_3_UP_TO_1G_WITH_UBUNTU_20_04_LTS
OS_JUNIPER_VSRX_21_4R3_UP_TO_1GBPS_STANDARD
OS_JUNIPER_VSRX_19_4R3S2_UP_TO_1GBPS_STANDARD
OS_VIRTUAL_ROUTER_APPLIANCE_20_X_UP_TO_2_GBPS_SUBSCRIPTION_EDITION_64_BIT
OS_VYATTA_5600_5_X_UP_TO_1GBPS_SUBSCRIPTION_EDITION_64_BIT
OS_NETWORK_GATEWAY_APPLIANCE_1GBPS_BRING_YOUR_OWN_APPLIANCE
OS_JUNIPER_VSRX_18_4_UP_TO_1GBPS_STANDARD_SRIOV
OS_JUNIPER_VSRX_20_4R2S2_UP_TO_1GBPS_STANDARD
OS_JUNIPER_VSRX_21_3R2S1_UP_TO_1GBPS_STANDARD
OS_JUNIPER_VSRX_20_4R3S2_UP_TO_1GBPS_STANDARD
OS_JUNIPER_VSRX_15_X_UP_TO_1GBPS_STANDARD_SRIOV
OS_JUNIPER_VSRX_23_2R1S1_UP_TO_1GBPS_STANDARD
OS_VIRTUAL_FORTIGATE_7_4_1_UP_TO_1G_WITH_UBUNTU_20_04_LTS
OS_VIRTUAL_FORTIGATE_7_4_2_UP_TO_1G_WITH_UBUNTU_20_04_LTS
OS_VIRTUAL_FORTIGATE_7_4_4_UP_TO_1G_WITH_UBUNTU_2
OS_JUNIPER_VSRX_15_X_UP_TO_1GBPS_STANDARD
OS_NO_OPERATING_SYSTEM
OS_JUNIPER_VSRX_19_4R2S3_UP_TO_1GBPS_STANDARD
...
```shell
ibmcloud sl order item-list VIRTUAL_ROUTER_APPLIANCE_10_GPBS --output json | jq -r '.[] | select(.itemCategory.categoryCode=="os") | .keyName'
OS_JUNIPER_VSRX_20_4R2S2_UP_TO_10GBPS_STANDARD
OS_VMWARE_SERVER_VIRTUALIZATION_6_7_UPDATE_3_UEFI
OS_JUNIPER_VSRX_23_2R1S1_UP_TO_10GBPS_STANDARD
OS_JUNIPER_VSRX_19_4R3S2_UP_TO_10GBPS_STANDARD
OS_JUNIPER_VSRX_21_3R2S1_UP_TO_10GBPS_STANDARD
OS_VIRTUAL_ROUTER_APPLIANCE_20_X_UP_TO_20_GBPS_SUBSCRIPTION_EDITION_64_BIT
OS_VMWARE_SERVER_VIRTUALIZATION_7_X_3_C_UEFI
OS_NETWORK_GATEWAY_APPLIANCE_10GBPS_BRING_YOUR_OWN_APPLIANCE
OS_JUNIPER_VSRX_19_4_UP_TO_10GBPS_STANDARD_SRIOV
OS_JUNIPER_VSRX_21_4R3_UP_TO_10GBPS_STANDARD
OS_JUNIPER_VSRX_22_2R2S2_UP_TO_10GBPS_STANDARD
OS_VIRTUAL_FORTIGATE_7_4_3_UP_TO_10G_WITH_UBUNTU_20_04_LTS
OS_VMWARE_SERVER_VIRTUALIZATION_6_7_UPDATE_3
OS_VMWARE_SERVER_VIRTUALIZATION_7_0_UPDATE_3_I_UEFI
OS_VMWARE_SERVER_VIRTUALIZATION_7_0_UPDATE_3I_UEFI
OS_VIRTUAL_FORTIGATE_7_4_1_UP_TO_10G_WITH_UBUNTU_20_04_LTS
OS_JUNIPER_VSRX_19_4R2S3_UP_TO_10GBPS_STANDARD
OS_VIRTUAL_FORTIGATE_7_4_4_UP_TO_10G_WITH_UBUNTU_20_04_LTS
OS_JUNIPER_VSRX_15_X_UP_TO_10_GBPS_STANDARD
OS_VIRTUAL_FORTIGATE_7_4_2_UP_TO_10G_WITH_UBUNTU_20_04_LTS
OS_VIRTUAL_ROUTER_APPLIANCE_19_X_UP_TO_20_GBPS_SUBSCRIPTION_EDITION_64_BIT
OS_JUNIPER_VSRX_20_4R3S2_UP_TO_10GBPS_STANDARD
OS_NO_OPERATING_SYSTEM
OS_JUNIPER_VSRX_15_X_UP_TO_10GBPS_STANDARD_SRIOV
OS_UBUNTU_22_04_LTS_JAMMY_JELLYFISH_64_BIT
```
...
## Retrieve the currently set ICR endpoint 
...
### Simple search by resource name
...
### Search for resources by cloud tag
