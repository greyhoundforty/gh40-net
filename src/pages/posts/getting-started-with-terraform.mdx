...
description: "Learn about Infrastructure as Code (IaC) by using Terraform to deploy an IBM Cloud VPC"
tags: ["ibmcloud", "terraform"]
---

[Terraform](https://www.terraform.io/) is an Infrastructure as Code (IaC) tool for creating and managing infrastrucure in a repeatable and consistent manner. Using the HashiCorp Configuration Language 
(HCL), you define your infrastrucuture resources in configuration files and Terraform will create, update, and destroy the resources as needed to meet the desired state.
