...
This guide will show you how to create a Code Engine project that will automatically refresh your Schematics workspace on set schedule.
...
- [IBM Cloud Code Engine plugin](https://cloud.ibm.com/docs/codeengine?topic=codeengine-cli#cli)
...
If you need help with cron syntax, I would recommend using [contab guru](https://crontab.guru/).